package com.itkluo.demo.widget.collapsibletextview;
...
public class CollapsibleTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private static final int TO_EXPAND_HINT_COLOR = 0xFF377FFF;
    private static final int TO_SHRINK_HINT_COLOR = 0xFF377FFF;
    ...
    public void setText(CharSequence text, BufferType type) {
        mOrigText = text.toString().replaceAll("[\n]", "");
        mBufferType = type;
//        setTextInternal(getNewTextByConfig(), type);
    ...
    public interface OnExpandListener {
        void onExpand(CollapsibleTextView view);

        void onShrink(CollapsibleTextView view);
    }
    ...
    private class TouchableSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            if (hasOnClickListeners()
                    && (getOnClickListener(CollapsibleTextView.this) instanceof ExpandableClickListener)) {
            } else {
                toggle();
            }
        }
